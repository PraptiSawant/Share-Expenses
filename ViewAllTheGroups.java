 ...
 */
public class ViewAllTheGroups extends javax.swing.JFrame {
    Connection con=DbConnect.dbconnect();
    String e[]=new String[20];
    int j=0,c=0,count=0;
    public ViewAllTheGroups() {
        initComponents();
        try{  
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(0, 0, 88));

        jLabel1.setFont(new java.awt.Font("Verdana", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 88));
        jLabel1.setText("VIEW ALL THE GROUPS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllTheGroups.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllTheGroups().setVisible(true);
            }
        });
    }
